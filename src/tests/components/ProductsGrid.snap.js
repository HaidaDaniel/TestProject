...
<body>
  <div>
    <div
      class="sc-jdkVqZ ehtRVN row"
    >
      <div
        class="sc-bZCZoC dHywrg col-lg-3 col-md-4 col-sm-6 col-12"
      >
        <div
          class="sc-bjEwCx kaOKZX"
          data-testid="product-item"
        >
          <div
            class="sc-idyqAC ijEMgL card"
          >
            <div
              class="sc-hHvkSs gmtLtY"
            >
              <a
                href="/products/1"
              >
            ...
            <div
              class="sc-dIEoRj eBEvqd"
            >
              <div
                class="sc-kgvdhe dDMVHm card-title h5"
              >
                <a
                  class="sc-fLBbxL eXgATz"
                  href="/products/1"
                >
              ...
              <div>
                <div
                  class="sc-ilpitK iRgmkc"
                >
                  <div
                    class="sc-ciJnBw fRpydl"
                  >
                    <span
                      class="sc-jIJgYh sc-hhWzdI dbcsNS jcrugB"
                      data-testid="filled"
                    >
                      ★
                    </span>
